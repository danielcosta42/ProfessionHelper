...
ProfessionHelper.Cooking = {
    ...
    recipes = {
        ...
        { name = "Roast Raptor", creates = 1, materials = { { name = "Raptor Flesh", count = 1 }, { name = "Hot Spices", count = 1 } }, orange = 175, yellow = 200, green = 215, grey = 230, source = "Vendor: Hammon Karwn (Arathi Highlands, Alliance) / Keena (Arathi Highlands, Horde)" },
        ...
        { name = "Buzzard Bites", creates = 1, materials = { { name = "Buzzard Meat", count = 1 } }, orange = 300, yellow = 320, green = 335, grey = 350, source = "Quest: Smooth as Butter (Hellfire Peninsula — final quest in the Ravager Egg Roundup chain)" },
        ...
        { name = "Warp Burger", creates = 1, materials = { { name = "Warped Flesh", count = 1 } }, orange = 325, yellow = 340, green = 350, grey = 360, source = "Vendor: Innkeeper Grilka (Stonebreaker Hold, Terokkar Forest, Horde) / Supply Officer Mills (Allerian Stronghold, Terokkar Forest, Alliance)" },
        { name = "Crunchy Serpent", creates = 1, materials = { { name = "Serpent Flesh", count = 1 } }, orange = 335, yellow = 345, green = 365, grey = 375, source = "Vendor: Xerintha Ravenoak (Ruuan Weald, Blade's Edge, Horde) / Sassa Weldwell (Toshley's Station, Blade's Edge, Alliance)" },
        { name = "Mok'Nathal Shortribs", creates = 1, materials = { { name = "Raptor Ribs", count = 1 } }, orange = 335, yellow = 345, green = 365, grey = 375, source = "Vendor: Xerintha Ravenoak (Blade's Edge, Horde) / Sassa Weldwell (Blade's Edge, Alliance) — also Quest: Mok'Nathal Treats (Blade's Edge)" },
    },
    ...
    levelingGuide = {
        ...
        },
        {
            ...
            source = "Vendor: Hammon Karwn (Arathi Highlands, Alliance) / Keena (Arathi Highlands, Horde)",
        ...
        },
        {
            ...
            source = "Vendor: Xerintha Ravenoak (Ruuan Weald, Blade's Edge, Horde) / Sassa Weldwell (Toshley's Station, Blade's Edge, Alliance)",
